...
//Librerie VIMEO API
require("/home/motorinews24.com/htdocs/vimeophp/autoload.php");
...
function register_button($buttons) {
  array_push($buttons, "video_mot24");
  return $buttons;
}

function add_plugin($plugin_array) {
  $plugin_array['video_mot24'] = get_stylesheet_directory_uri().'/js/customcodes.js';
  return $plugin_array;
}
...
// Video Player Engine
wp_enqueue_script( 'video_mot24_js', get_stylesheet_directory_uri().'/js/video_mot24.js' );

// Video Player
function video_mot24($atts, $content = null) {
  ...
  $playerdiv = '<div class="playerHolder"><div id="SportreviewPlayer-'.$videoid[1].'"></div></div>';
  $playerdiv .= '<script>VideoSportReview("'.$url.'","'.$autoplay.'","'.$width.'","'.$height.'","'.$mute.'","'.$repeat.'","'.$videoid[1].'");</script>';
  return $playerdiv;

}
add_shortcode("video_mot24", "video_mot24");

// Old Video Player - per vecchi video prima del 2017
function video_old_mot24($content = null) {

	// extract custom post field attributes
	global $vimeo_playvideo;
	$array = explode('"', $vimeo_playvideo);
...
// Sliding Player
function videoslide_mot24($atts, $content = null) {
  ...
  /*
     ...
     //Librerie JS is mobile
       ...
       if (!isMobileNewtek && homepageURL=="http://www.motorinews24.com/") {
            var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/motori.sportreview/hp/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/motori.sportreview/hp/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var tagpreroll2repeat = prerollTagSidebar;
            var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/MotoriNews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/Motori.Sportreview.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=885151&w=16&h=9';
          } else if (!isMobileNewtek) {
            var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/motori.sportreview/altro/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/motori.sportreview/altro/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var prerollTagSidebarRepeat = prerollTagSidebar;
            var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/MotoriNews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/Motori.Sportreview.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=885151&w=16&h=9';
          } else {
            var prerollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/motori.sportreview/mobile/preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var postrollTagSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/5196/motori.sportreview/mobile/postroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var prerollTagSidebarRepeat = prerollTagSidebar;
            var dfpSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/165059490/MotoriNews24_Preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var mediamaticSidebar = 'https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/1028390/Motori.Sportreview.TM.preroll&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&url=motorinews24.com&description_url=motorinews24.com&correlator='+Math.round(Math.random()*10000000000)+'';
            var mediamaticFallbackSidebar = 'https://ad.360yield.com/advast?p=885151&w=16&h=9';
      ...
      //var bitrates = { hls: 'video_playlists[0]' };
       ...
       var settings = {
         logo: '<?php //echo site_url(); ?>/wp-content/themes/Newspaper-child/images/logo-mot24-video.png',
  ...
  */
  ...
  <!-- Mediamatic | Special - 307x220 | 319 & 348 -->
  <div id='sy_56355' align='center'></div>
  <script>
    ...
    mmTag.push({mmSetPubId:348});
      mmTag.push({mmSetWeight:307});
      mmTag.push({mmSetHeight:220});
      }
    mmTag.push({mmSetDivId:'sy_56355'});
...
add_shortcode("videoslide_mot24", "videoslide_mot24");

// Video Playlist HOME
function video_playlist_mot24($atts, $content = null) {
...
?>
  ...
  <div class="td-container playlist-container">
    ...
    <script>
        ...
        console.log("Engine by Riccardo Mel:  Playlist Home HLS V2 - Init ok");
...
add_shortcode("video_playlist_mot24", "video_playlist_mot24");
...
function adv_libs() { ?>
  ...
  if (!isMobileNewtek) {
    ...
    googletag.cmd.push(function() {
      ...
      googletag.defineSlot('/67970281/display_thirdparty_it/motorinews24_responsive/homepage/top_banner', [320, 50], 'div-gpt-ad-1521735814204-3').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());
      googletag.defineSlot('/67970281/display_thirdparty_it/motorinews24_responsive/ros/top_banner', [320, 50], 'div-gpt-ad-1521735937791-2').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());
      googletag.defineSlot('/67970281/display_thirdparty_it/motorinews24_responsive/homepage/top_mpu', [300, 250], 'div-gpt-ad-1521735814204-2').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads());
      googletag.defineSlot('/67970281/display_thirdparty_it/motorinews24_responsive/ros/top_mpu', [300, 250], 'div-gpt-ad-1521735937791-3').setTargeting('Display_Ad_Position', ['ATF']).addService(googletag.pubads()); 
      googletag.pubads().enableSingleRequest();
      googletag.pubads().collapseEmptyDivs();
      googletag.enableServices();
    });
...
jQuery("#div-gpt-ad-1521735814204-1").hide();
}
</script>
</div>
  <?php } else { ?>
    ...
    <div id='div-gpt-ad-1521735937791-1' style='height:1px; width:1px;'>
      <script>
        if (!isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521735937791-1").hide();
        }
      </script>
    </div>
  <?php }
...
<script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521735814204-0").hide();
        }
      </script>
    </div>
  <?php } else { ?>
    ...
    <div id='div-gpt-ad-1521735937791-0'>
      <script>
        if (isMobileNewtek) {
          ...
          jQuery("#div-gpt-ad-1521735937791-0").hide();
        }
      </script>
    </div>
  <?php }
...
function adv_top_mobile() { ?>
  <!-- /67970281/display_thirdparty_it/motorinews24_responsive/homepage/top_mpu -->
  <div id='div-gpt-ad-1521735814204-2'>
  <script>
    if (isMobileNewtek) {
      googletag.cmd.push(function() { googletag.display('div-gpt-ad-1521735814204-2'); });
    } else {
      jQuery("#div-gpt-ad-1521735814204-2").hide();
    }
  </script>
  </div>
<?php }//adv_top_mobile
...
function adv_top_mobile_single() {
  if (is_single()) { ?>
    <script type="text/javascript">
    if (isMobileNewtek) {
      top_mobile_content = '<!-- /67970281/display_thirdparty_it/motorinews24_responsive/ros/top_mpu -->\
        <div id="div-gpt-ad-1521735937791-3">\
        <script>\
          if (isMobileNewtek) {\
            googletag.cmd.push(function() { googletag.display("div-gpt-ad-1521735937791-3"); });\
          } else {\
            jQuery("#div-gpt-ad-1521735937791-3").hide();\
          }\
        <\/script>\
        <\/div>';
...
function adv_bottom_mobile() {
  if (is_front_page()) { ?>
   <!-- /67970281/display_thirdparty_it/motorinews24_responsive/homepage/top_banner -->
<div id='div-gpt-ad-1521735814204-3' style='height:50px; width:320px;'>
<script>
        if (isMobileNewtek) {
  ...
  <?php } else { ?>
    <!-- /67970281/display_thirdparty_it/motorinews24_responsive/ros/top_banner -->
    <div id='div-gpt-ad-1521735937791-2' style='height:50px; width:320px;'>
      <script>
        if (isMobileNewtek) {
          googletag.cmd.push(function() { googletag.display('div-gpt-ad-1521735937791-2'); });
        } else {
